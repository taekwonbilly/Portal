...
public abstract class LwjglLightStateUtil {
    ...
    /**
	 * Sets the specular control.
	 * 
	 * @param separateSpecularOn
	 *            the separate specular on
	 * @param record
	 *            the record
	 */
