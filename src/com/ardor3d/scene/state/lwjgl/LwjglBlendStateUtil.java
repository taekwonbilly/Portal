...
public abstract class LwjglBlendStateUtil {
	 ...
	 * 
	 * @param sampleAlphaToCoverageEnabled
	 *            the sample alpha to coverage enabled
	 * @param sampleAlphaToOneEnabled
	 *            the sample alpha to one enabled
	 * @param record
	 *            the record
	 * @param caps
	 *            the caps
    ...
    /**
	 * Gets the gL src value.
	 * 
	 * @param function
	 *            the function
	 * @param caps
	 *            the caps
	 * @return the gL src value
	 */
    ...
    /**
	 * Gets the gL dst value.
	 * 
	 * @param function
	 *            the function
	 * @param caps
	 *            the caps
	 * @return the gL dst value
	 */
    ...
    /**
	 * Gets the gL equation value.
	 * 
	 * @param eq
	 *            the eq
	 * @param caps
	 *            the caps
	 * @return the gL equation value
	 */
    ...
    /**
	 * Gets the gL func value.
	 * 
	 * @param function
	 *            the function
	 * @return the gL func value
	 */
