...
public class LwjglTextureRenderer extends AbstractFBOTextureRenderer {
    ...
    /**
	 * Instantiates a new lwjgl texture renderer.
	 * 
	 * @param width
	 *            the width
	 * @param height
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.TextureRenderer#render(com.ardor3d.scenegraph.Spatial, java.util.List, int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.TextureRenderer#render(java.util.List, java.util.List, int)
     */
   ...
   // @Override
    /* (non-Javadoc)
    * @see com.ardor3d.renderer.TextureRenderer#render(com.ardor3d.framework.Scene, java.util.List, int)
    */
   public void render(final Scene scene, final List<Texture> texs, final int clear) {
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.AbstractFBOTextureRenderer#setupForSingleTexDraw(com.ardor3d.image.Texture)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.AbstractFBOTextureRenderer#takedownForSingleTexDraw(com.ardor3d.image.Texture)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.AbstractFBOTextureRenderer#setMSFBO()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.AbstractFBOTextureRenderer#blitMSFBO()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.TextureRenderer#copyToTexture(com.ardor3d.image.Texture, int, int, int, int, int, int)
     */
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.AbstractFBOTextureRenderer#clearBuffers(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.AbstractFBOTextureRenderer#activate()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.AbstractFBOTextureRenderer#deactivate()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.TextureRenderer#cleanup()
     */
    public void cleanup() {
        if (_fboID != 0) {
