...
/**
 * The Class LwjglTextureRendererProvider.
 */
public class LwjglTextureRendererProvider implements TextureRendererProvider {
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.TextureRendererProvider#createTextureRenderer(int, int, com.ardor3d.renderer.Renderer, com.ardor3d.renderer.ContextCapabilities)
     */
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.TextureRendererProvider#createTextureRenderer(int, int, int, int, com.ardor3d.renderer.Renderer, com.ardor3d.renderer.ContextCapabilities)
     */
    ...
    /* (non-Javadoc)
     * @see com.ardor3d.renderer.TextureRendererProvider#createTextureRenderer(com.ardor3d.framework.DisplaySettings, boolean, com.ardor3d.renderer.Renderer, com.ardor3d.renderer.ContextCapabilities)
     */
